...
- ~~**Does an Angel, asked point-blank, deny it?**~~ **ANSWERED 9/13 (mikel) — the question dissolves, and the answer is better than either branch.** There is no Angel policy and no such thing as what "an Angel" would say: Angels have Caretaker capabilities and information but **human perspectives**, individual personalities and histories, and **broad discretion**, trained only to preserve the preserve's invariants while observing Praxis ethics (`18-the-caretakers-virtue.md`).

  **So the Wakeful have never been tested against a wall. They have been tested against a distribution** — four and a half thousand years of *contradictory* testimony, every account of it genuine. One Angel denies it plainly. One declines. One asks what the questioner means. One answers truthfully and is not understood. One judges that a denial would ruin a dying woman's last hour and says nothing at all.

  **That is far better fuel for a faith than uniform denial.** A wall is a hard fact to explain away; a scatter of answers is **a corpus** — and a corpus produces exegesis, canonical encounters, disputed ones, forgeries, and schools that weight them differently. Inconsistent testimony is how real traditions are actually built. The Wakeful's problem is not that they are denied; it is that they have **too much evidence pointing different ways**, which is the human condition with respect to revelation.

  **It also grounds the wings in something principled — which encounters each of them weights:** quietists favour the encounters where an Angel deflected gently (proof of the protocol); hasteners favour the ones where an Angel did something dramatic (proof they can be moved); the polemic wing favours the ones where an Angel plainly denied the Church's claims about itself (proof the Angels are not the Makers'); receivers favour the ambiguous ones. **And the receivers are not all frauds:** some of what they report is a real Angel encounter, honestly relayed by someone who misunderstood it.
